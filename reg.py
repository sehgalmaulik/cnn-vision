...
data_augementation_transform = transforms.Compose([
...
train_conv_fc = datasets.ImageFolder(train_dir, transform=data_augementation_transform)
test_conv_fc = datasets.ImageFolder(test_dir, transform=simple_transform)


train_loader_conv_fc = DataLoader(train_conv_fc,
                                batch_size=BATCH_SIZE,
                                num_workers=0,
                                shuffle=True)

test_loader_conv_fc = DataLoader(test_conv_fc,   
                                batch_size=BATCH_SIZE,
                                num_workers=0,
                                shuffle=False)
...
model_0 = ConvFC(input_shape=3, hidden_units=HIDDEN_LAYER_SIZE, output_shape=len(class_names)).to(device)
...
history_0 = train(model_0, train_loader_conv_fc, test_loader_conv_fc, loss_fn_0, optimizer_0, NUM_EPOCHS, device)
